...
public class Expense implements Refreshlist {
    ...
    protected void btnRemoveExpenseActionPerformed() {
        ...
        try {FXMLLoader fxmlLoader = new FXMLLoader(LoginScreen.class.getResource("RemoveExpense.fxml"));
            Parent root = fxmlLoader.load();
            Scene newScene = new Scene(root);
            Stage newStage = new Stage();
            newStage.initStyle(StageStyle.UNDECORATED);
    ...
    public void refreshExpenses() {setBtnrefresh();}
    @FXML
    protected void btnReturnHome(){
        System.out.println("Return Button Pressed " + Date.from(java.time.Instant.now()));
        try {FXMLLoader fxmlLoader = new FXMLLoader(LoginScreen.class.getResource("HomeScreen.fxml"));
            Parent root = fxmlLoader.load();
            Scene newScene = new Scene(root);
            Stage newStage = new Stage();
            newStage.initStyle(StageStyle.UNDECORATED);
