...
import com.example.app.services.DatabaseConnection;
...
public class MenuItemPanel implements RefreshMenulist {
	...
	@FXML
	private TableView<com.example.app.models.MenuItem> menuitemstv;

	@FXML
	private TableColumn<com.example.app.models.MenuItem, String> nameclmn, descriptionclmn, categoryclmn, priceclmn;

	@FXML
	private TableColumn<com.example.app.models.MenuItem, ArrayList<String>> ingredientsclmn;

	@FXML
	private TableColumn<com.example.app.models.MenuItem, Void> removebtnclmn;
	...
	private void setupRemoveButton() {
		removebtnclmn.setCellFactory(column -> new TableCell<com.example.app.models.MenuItem, Void>() {
...

			{
				removeButton.setOnAction(event -> {
					...
					if (index >= 0 && index < getTableView().getItems().size()) {
						com.example.app.models.MenuItem item = getTableView().getItems().get(index);
						try {
							com.example.app.models.MenuItem.removeMenuItem(item);
	...
	public void refreshMenuList() {
		...
		ObservableList<com.example.app.models.MenuItem> menuItems = FXCollections.observableArrayList(com.example.app.models.MenuItem.getMenuItems());
	...
	private TreeView<Object> createFilterTreeView() {
		...
		for (String ingredient : com.example.app.models.MenuItem.getAllIngredients()) {
	...
	private void filterItems(List<String> selectedCategories, List<String> selectedIngredients, double priceRange) {
		ObservableList<com.example.app.models.MenuItem> allMenuItems = FXCollections.observableArrayList(com.example.app.models.MenuItem.getMenuItems());
		ObservableList<com.example.app.models.MenuItem> filteredMenuItems = FXCollections.observableArrayList();

		for (com.example.app.models.MenuItem menuItem : allMenuItems) {
