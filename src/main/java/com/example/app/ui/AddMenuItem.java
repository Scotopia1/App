...
import com.example.app.utils.RefreshMenulist;
import com.example.app.utils.MenuItemPanel;
...
public class AddMenuItem implements RefreshMenulist {
	...
	public void btnaddMenuItem() {
		...
		if (name.isEmpty() || pricetxt.isEmpty() || cattxt.isEmpty() || ingredients.isEmpty()) {
		...
		} else if (com.example.app.models.MenuItem.MenuItemExists(name, category)) {
			...
			com.example.app.models.MenuItem menuItem = new com.example.app.models.MenuItem(name, description, category, price, ingredients);
	...
	// This method is for setting the refresh interface
	public void setRefreshMenulist(RefreshMenulist refreshMenulist) {
	...
	// This method is for the RefreshMenulist interface override
	@Override
