...
public class EditMenuItem implements RefreshMenulist {
	...
	public void setBtnapply() {
		...
		if (namecb.getValue() == null || pricetf.getText().isEmpty()
			...
			com.example.app.models.MenuItem item = com.example.app.models.MenuItem.getMenuItem(namecb.getValue());
	...
	private ArrayList<String> getNames() {
		...
		for (com.example.app.models.MenuItem item : com.example.app.models.MenuItem.getAllMenuItems()) {
